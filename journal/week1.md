...
4. Use Amazon ECR for Image Management
...
7. Enable IAM Roles for Tasks (ECS/EKS)
...
8. Use AWS Fargate for Serverless Containers
...
9. Monitor with AWS CloudWatch and X-Ray
